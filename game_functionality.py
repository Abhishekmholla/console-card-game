...
class GameFunctionality():
    ...
    def get_game_menu():
        ...
        GameFunctionality.print_message("Please select one of the following options\n"
                                        "1.Start game\n"
                                        "2.Pick a card\n"
                                        "3.Shuffle Deck\n"
                                        "4.Show my cards\n"
    ...
    def show_card(player_cards):
        ...
        """
        GameFunctionality.print_message("Here is your set of cards mate!!!")
        GameFunctionality.print_message(",".join(player_cards))

    @staticmethod
    def print_outcome_of_game(player_cards, robot_cards, selected_suit, card_values, is_game_started):
        game_rule = game_rules()
        game_result = game_rule.check_result(
            player_cards, robot_cards, selected_suit, card_values)
