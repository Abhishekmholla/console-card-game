class game_rules:
    ...
    def check_result(self,player_cards, robot_cards, selected_suit, card_value):
        ...
        game_result = self.__check_card_average_value(player_cards, robot_cards)
    ...
    def __check_minimum_suit_value(self,player_cards, robot_cards, selected_suit, card_value):
        ...
        is_player_count_matched = desired_count.get('player_count') == len(selected_suit) - 1
        is_robot_count_matched = desired_count.get('robot_count') == len(selected_suit) - 1
    ...
    def __check_suit_value(self,player_cards, robot_cards, selected_suit, card_value):
        ...
        is_player_card_matched = any(set(item) <= set(player_cards) for item in desired_suit)

        # Check if the list of desired cards is a subset of robot_cards
        is_robot_card_matched = any(set(item) <= set(robot_cards) for item in desired_suit)
